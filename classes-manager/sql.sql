...
-- Dumping data for table f8_project_classoffline.logintokens: ~0 rows (approximately)
...
-- Dumping data for table f8_project_classoffline.permissions: ~5 rows (approximately)
...
-- Dumping data for table f8_project_classoffline.userotps: ~0 rows (approximately)
...
-- Dumping data for table f8_project_classoffline.users: ~3 rows (approximately)
INSERT INTO `users` (`id`, `name`, `email`, `password`, `phone`, `address`, `typeId`, `firstLogin`, `createdAt`, `updatedAt`) VALUES
	(1, 'Đức Hiền', 'mdhien2302@gmail.com', '$2b$10$rFSKkH5PU3SqzVDcO/iQr./RLmm4Frur5G..uK9fPrvlT0LHJUZIG', '0869998888', 'Hà Nội', 1, 0, '2024-02-19 09:56:27', '2024-02-19 09:56:27'),
...
-- Dumping data for table f8_project_classoffline.user_permissions: ~0 rows (approximately)
